...
GameStore.Categories = {
	...
	-- Primos custom
	{
		...
		name = "Primos Shop",
		rookgaard = true,
		subclasses = { "Primos Custom", "Primos Backpacks", "Primos dummy", "Primos box", "Primos Set" },
	},
	--Primos Custom
	{
		...
		offers = {
			{
				...
				itemtype = 9598,
				count = 1,
				description = "This nifty gadget can be used for many vital and less vital purposes. If it's not jammed, that is. It weighs 3.00 oz.",
			...
			},
			{
				...
				itemtype = 44095,
				count = 1,
				description = "Citizen - Hunter - Knight - Noble - Warrior - Barbarian - Druid - Wizard - Oriental - Pirate - Assassin - Beggar - Shaman - Norse - Nightmare - Jester - Brotherhood - Demonhunter - Yalaharian - Warmaster - Wayfarer - Afflicted - Elementalist - Deepling - Insectoid - Entrepreneur - Crystal Warlord - Soil Guardian - Demon - Cave Explorer - Dream Warden - Champion - Conjurer - Beastmaster - Chaos Acolyte - Death Herald - Ranger - Ceremonial Garb - Puppeteer - Spirit Caller - Evoker - Seaweaver - Recruiter - Sea Dog - Royal Pumpkin",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				home = true,
			},
			{
			...
			},
			{
				...
				name = "Roulette Primos Coin",
				price = 80,
				itemtype = 44065,
				count = 1,
				description = "Ticket utilizado para tentar a sorte na roleta.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				home = true,
			},
			{
				icons = { "Tibiora's_Box.png" },
				name = "Roulette Primos Coin",
				price = 350,
				itemtype = 44065,
				count = 5,
			...
			},
			{
				...
				itemtype = 28495,
				count = 1,
				description = "Refill Stamina Full",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},			
			{
				icons = { "Chaos_Critical_Dice.png" },
				name = "Teleport Primos Scroll",
				price = 110,
				itemtype = 31633,
				count = 1,
				description = "Teleport Infinito",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				home = true,
			},
		},
		...
		offers = {
			{
				...
				itemtype = 44064,
				count = 1,
				description = "(critical hitchance +10, fighting all +5, life leech chance +100, life leech amount +3, mana leech chance +100, mana leech amount +3, magic level +5, protection all +3).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Whacking_Driller_of_Fate.png" },
				name = "Dalbens Backpack",
				price = 50,
				itemtype = 44080,
				count = 1,
				description = "(critical hIt chance 10%). 35 Slots",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},	
			{
				icons = { "Whacking_Driller_of_Fate.png" },
				name = "Sudden Death Backpack.",
				price = 50,
				itemtype = 44081,
				count = 1,
				description = "(Protction death +10%). 35 Slots.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Whacking_Driller_of_Fate.png" },
				name = "Shenlong Backpack",
				price = 50,
				itemtype = 44082,
				count = 1,
				description = "(Protection Earth +10%). 35 Slots.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 44083,
				count = 1,
				description = "(protection energy 10%).35 Slots.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 44085,
				count = 1,
				description = "(PROTECTION HOLY +10%) 35Slots.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},	
			{
				icons = { "Whacking_Driller_of_Fate.png" },
				name = "Mewtwo Backpack",
				price = 50,
				itemtype = 44086,
				count = 1,
				description = "(PROTECTION ICE +10%) 35Slots.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},	
			{
				icons = { "Whacking_Driller_of_Fate.png" },
				name = "Kyuubi Backpack",
				price = 50,
				itemtype = 44087,
				count = 1,
				description = "(mana leech chance+100%, mana leech amount +5%).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Whacking_Driller_of_Fate.png" },
				name = "Alchemist Backpack",
				price = 50,
				itemtype = 44088,
				count = 1,
				description = "protection manadrain +10%.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},	
			{
				...
				itemtype = 44089,
				count = 1,
				description = "Protection physical +7%.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Whacking_Driller_of_Fate.png" },
				name = "Captain America Backpack",
				price = 50,
				itemtype = 44090,
				count = 1,
				description = "DAMAGE REFLECTION +5, PROTECTION PHYSICAL+5",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Whacking_Driller_of_Fate.png" },
				name = "Majin Boo Backpack",
				price = 50,
				itemtype = 44091,
				count = 1,
				description = "Regen 5MP 5HP in 5s",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 44092,
				count = 1,
				description = "Perfect shot +20 at range 4.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Whacking_Driller_of_Fate.png" },
				name = "Iron Man Backpack",
				price = 50,
				itemtype = 44093,
				count = 1,
				description = "speed +100 protection drown +100%.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},				
			{
				icons = { "Chaos_Critical_Dice.png" },
				name = "White King Backpack",
				price = 50,
				itemtype = 44084,
				count = 1,
				description = "(protection fire +10%). 35Slots.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
		},
		...
		--Primos Custom
	{
		...
		offers = {
			...
			{
				icons = { "Tibiora's_Box.png" },
				name = "Primos Lion Box",
				price = 100,
				itemtype = 44069,
				count = 1,
				description = "Item Lion aleatorio",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				home = true,
			},
			{
			...
			{
				icons = { "Tibiora's_Box.png" },
				name = "Primos Cobra Box",
				price = 100,
				itemtype = 44070,
				count = 1,
				description = "Item Cobra aleatorio",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Tibiora's_Box.png" },
				...
				itemtype = 44070,
				count = 5,
				description = "Item Cobra aleatório",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Tibiora's_Box.png" },
				name = "Primos Gnome Box",
				price = 100,
				itemtype = 44068,
				count = 1,
				description = "Item Gnome aleatorio",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				home = true,
			},
			{
			...
			{
				icons = { "Tibiora's_Box.png" },
				name = "Primos Oberon Box",
				price = 100,
				itemtype = 44066,
				count = 1,
				description = "Item falcon aleatorio",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				home = true,
			},
			{
			...
			},
			{
				...
				itemtype = 34109,
				count = 1,
				description = "Item Soul aleatorio",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Tibiora's_Box.png" },
				...
				itemtype = 39546,
				count = 1,
				description = "Item Primal aleatorio",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Tibiora's_Box.png" },
				...
				itemtype = 43895,
				count = 1,
				description = "Item Sanguine aleatorio",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
		},
	},
		...
		offers = {
			{
				...
				name = "Angel of Death Dummy",
				price = 200,
				itemtype = 44073,
				count = 1,
				description = "<i>Train your skills more effectively at home than in public on this expert exercise dummy! 15% bonus </i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Ferumbras_Exercise_Dummy.png" },
				name = "Gorgon Demon Dummy",
				price = 200,
				itemtype = 44078,
				count = 1,
				description = "<i>Train your skills more effectively at home than in public on this expert exercise dummy!15% bonus </i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
		...
		offers = {
			{
				...
				itemtype = 44105,
				count = 1,
				description = "Protect all 5%, 100 speed, 1 slot imbuiment",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Whacking_Driller_of_Fate.png" },
				name = "Primos Regeneration",
				price = 200,
				itemtype = 44072,
				count = 1,
				description = "(critical extra damage +10, reflect +10, Regen mana +15/3sec, life 8/3sec).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 44101,
				count = 1,
				description = "Arm+5, Protect All +5%, 1 slot imbuiment",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},			
			{
				icons = { "Chaos_Critical_Dice.png" },
				name = "Primos Knight Ring",
				price = 200,
				itemtype = 44102,
				count = 1,
				description = "Arm +5, Protect all +5%, +3 axe, +3 sword, +3 club, +3 fist, +3 shield.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Chaos_Critical_Dice.png" },
				name = "Primos Mage Ring",
				price = 200,
				itemtype = 44104,
				count = 1,
				description = "Arm +5, Protect all +5%, +3 magic level, +3 fist.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				icons = { "Chaos_Critical_Dice.png" },
				name = "Primos Paladin Ring",
				price = 200,
				itemtype = 44103,
				count = 1,
				description = "Arm +5, Protect all +5%, +3 distance, +3 fist.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
		},
