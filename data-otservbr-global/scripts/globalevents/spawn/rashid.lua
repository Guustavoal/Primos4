local positionByDay = {
	[1] = { position = Position(32353, 32222, 5), city = "Carlin" }, -- Sunday
	[2] = { position = Position(32353, 32222, 5), city = "Svarground" }, -- Monday
	[3] = { position = Position(32353, 32222, 5), city = "Liberty Bay" }, -- Tuesday
	[4] = { position = Position(32353, 32222, 5), city = "Port Hope" }, -- Wednesday
	[5] = { position = Position(32353, 32222, 5), city = "Ankrahmun" }, -- Thursday
	[6] = { position = Position(32353, 32222, 5), city = "Darashia" }, -- Friday
	[7] = { position = Position(32353, 32222, 5), city = "Edron" }, -- Saturday
}
