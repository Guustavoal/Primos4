...
monster.attacks = {
	...
	{name ="combat", interval = 3000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -800, maxDamage = -900, range = 7, radius = 4, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="combat", interval = 3000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -1000, maxDamage = -900, range = 7, radius = 4, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYAREA, target = true},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_HOLYDAMAGE, minDamage = -1050, maxDamage = -800, range = 7, shootEffect = CONST_ANI_SMALLHOLY, effect = CONST_ME_HOLYDAMAGE, target = true},
	{name ="extended holy chain", interval = 2000, chance = 15, minDamage = -1030, maxDamage = -850, range = 7},
}
