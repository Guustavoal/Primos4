...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -300, maxDamage = -650, length = 5, spread = 2, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -260, maxDamage = -650, range = 7, radius = 3, effect = CONST_ME_ENERGYAREA, target = true}
}
