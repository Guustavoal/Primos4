local mType = Game.createMonsterType("Aldebaran")
local monster = {}

monster.description = "Aldebaran"
...
monster.loot = {
	{name = "crystal coin", chance = 10000, maxCount = 30},
	{name = "gold ingot", chance = 10000, maxCount = 7},
	{name = "small diamond", chance = 10000, maxCount = 40},
	{name = "small emerald", chance = 10000, maxCount = 50},
	{name = "Primos Lion Box", chance = 250, maxCount = 1},
	...
	{name = "Primos Token", chance = 500, maxCount = 20},
