local mType = Game.createMonsterType("Camus")
local monster = {}

monster.description = "Camus"
...
monster.loot = {
	...
	{name = "gold ingot", chance = 10000, maxCount = 10},
	...
	{name = "Portella Backpack", chance = 502500, maxCount = 1},
	{name = "Primos Blessed Backpack", chance = 250, maxCount = 1},
	{name = "Primos Scarlett Box", chance = 250, maxCount = 1},
