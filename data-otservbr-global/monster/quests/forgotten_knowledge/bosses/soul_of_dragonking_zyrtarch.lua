...
monster.loot = {
	...
	{ id = 3031, chance = 97000, maxCount = 100 }, -- gold coin
	{ id = 3037, chance = 2000, minCount = 1, maxCount = 3  }, -- yellow gem
	{ id = 5882, chance = 5000, minCount = 1, maxCount = 3  }, -- red dragon scale
	{ id = 5889, chance = 2500, minCount = 1, maxCount = 3  }, -- piece of draconian steel
	{ id = 9067, chance = 2500, minCount = 1, maxCount = 3  }, -- crystal of power
	{ id = 11688, chance = 300 }, -- shield of corruption
	{ id = 9057, chance = 3000, maxCount = 15 }, -- small topaz
	{ id = 3032, chance = 3000, maxCount = 15 }, -- small emerald
	{ id = 9058, chance = 1500, minCount = 1, maxCount = 3  }, -- gold ingot
	{ id = 10391, chance = 100 }, -- drachaku
	{ id = 3033, chance = 3000, maxCount = 15 }, -- small amethyst
	{ id = 8021, chance = 500 }, -- modified crossbow
	{ id = 3041, chance = 2000 , minCount = 1, maxCount = 5 }, -- blue gem
	...
	{ id = 3038, chance = 2000, minCount = 1, maxCount = 3  }, -- green gem
	{ id = 5948, chance = 5000 }, -- red dragon leather
	{ id = 5904, chance = 1500 }, -- magic sulphur
	{ id = 24955, chance = 1050, unique = true }, -- part of a rune
	...
	{ id = 3030, chance = 3000, maxCount = 15 }, -- small ruby
}
