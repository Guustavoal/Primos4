...
monster.loot = {
	...
	{ id = 3041, chance = 100000, minCount = 1, maxCount = 3  }, -- blue gem
	{ id = 3038, chance = 100000, minCount = 1, maxCount = 3  }, -- green gem
	...
	{ id = 3036, chance = 2000, minCount = 1, maxCount = 5  }, -- violet gem
	{ id = 3037, chance = 2000, minCount = 1, maxCount = 5  }, -- yellow gem
	{ id = 10323, chance = 2000 }, -- guardian boots
	{ id = 3324, chance = 2000 }, -- skull staff
	{ id = 3081, chance = 2000 }, -- stone skin amulet
	{ id = 10323, chance = 1000 }, -- guardian boots
	{ id = 24956, chance = 600, unique = true }, -- part of a rune
	{ id = 8076, chance = 1000 }, -- spellscroll of prophecies
	{ id = 5809, chance = 100, unique = true }, -- soul stone
	{ id = 3439, chance = 400 }, -- phoenix shield
	{ id = 7417, chance = 400 }, -- runed sword
