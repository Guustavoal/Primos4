...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_ENERGYDAMAGE, minDamage = -400, maxDamage = -750, range = 5, shootEffect = CONST_ANI_ENERGY, target = true},
	{name ="lavafungus ring", interval = 2000, chance = 20, minDamage = -600, maxDamage = -850},
}
