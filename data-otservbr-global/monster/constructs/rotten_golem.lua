...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -20, maxDamage = -550},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_HOLYDAMAGE, minDamage = -720, maxDamage = -850, range = 7, shootEffect = CONST_ANI_SMALLHOLY, effect = CONST_ME_HOLYAREA, target = true},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -520, maxDamage = -800, radius = 5, effect = CONST_ME_BIGPLANTS, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -620, maxDamage = -800, radius = 7, effect = CONST_ME_BIGPLANTS, target = false},
	{name ="poison chain", interval = 2000, chance = 20, minDamage = -570, maxDamage = -700, radius = 7, effect = CONST_ME_BIGPLANTS, target = false},
