...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -740, maxDamage = -900, range = 7, shootEffect = CONST_ANI_SNOWBALL, effect = CONST_ME_ICEATTACK, target = true},
	{name ="combat", interval = 2000, chance = 12, type = COMBAT_ICEDAMAGE, minDamage = -620, maxDamage = -950, range = 7, radius = 5, shootEffect = CONST_ANI_ICE, effect = CONST_ME_ICEAREA, target = true},
	{name ="combat", interval = 2001, chance = 17, type = COMBAT_HOLYDAMAGE, minDamage = -670, maxDamage = -700, radius = 4, effect = CONST_ME_HOLYAREA, target = false},
	{name ="extended holy chain", interval = 2000, chance = 15, minDamage = -570, maxDamage = -600, range = 7},
}
