...
monster.description = "Mycobiontic Beetle"
monster.experience = 24360
monster.outfit = {
	lookType = 1620,
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 1500, chance = 25, type = COMBAT_ENERGYDAMAGE, minDamage = -320, maxDamage = -900, length = 4, spread = 3, effect = CONST_ME_ENERGYHIT, target = false },
