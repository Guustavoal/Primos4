...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = -320, maxDamage = -1100 },
	...
	{ name = "combat", interval = 1500, chance = 35, type = COMBAT_DEATHDAMAGE, minDamage = -240, maxDamage = -1050, radius = 4, effect = CONST_ME_MORTAREA, target = false },
