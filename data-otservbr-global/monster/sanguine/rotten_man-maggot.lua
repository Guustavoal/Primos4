...
monster.attacks = {
	...
	{ name = "combat", interval = 1500, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -350, maxDamage = -1200, radius = 3, shootEffect = CONST_ANI_ENVENOMEDARROW, target = true },
	...
	{ name = "combat", interval = 1500, chance = 35, type = COMBAT_DEATHDAMAGE, minDamage = -350, maxDamage = -850, radius = 4, effect = CONST_ME_MORTAREA, target = false },
