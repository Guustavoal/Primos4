...
monster.attacks = {
	...
	{ name = "combat", interval = 1500, chance = 25, type = COMBAT_ENERGYDAMAGE, minDamage = -240, maxDamage = -1150, length = 4, spread = 3, effect = CONST_ME_ENERGYHIT, target = false },
	...
	{ name = "combat", interval = 1500, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -240, maxDamage = -850, radius = 4, effect = CONST_ME_FIREAREA, target = false },
}
