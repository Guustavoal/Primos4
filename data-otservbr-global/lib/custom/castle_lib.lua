-- Variaveis
CASTLE_KICK_POSITION = Position(32335, 32199, 7)
...
function stopInvasion()
	...
	--get the players e poe invading false
	local playersInZone = zone:getPlayers()
	for _, __player in ipairs(playersInZone) do
		setInvadingCastle(__player, false)
	end
	zone:removePlayers()
	zone:removeMonsters()
...
function canEnterCastle()
	local cooldown = getCastleCooldown()
